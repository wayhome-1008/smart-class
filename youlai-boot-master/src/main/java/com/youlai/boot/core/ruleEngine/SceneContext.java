//package com.youlai.boot.core.ruleEngine;
//
//
//import com.alibaba.fastjson.JSON;
//import com.youlai.boot.common.util.SpringUtils;
//import com.youlai.boot.device.service.DeviceService;
//import com.youlai.boot.scene.model.form.ScriptTemplate;
//import com.youlai.boot.scene.model.vo.SceneThingsModelItem;
//import com.youlai.boot.scene.model.vo.ThingsModelSimpleItem;
//import lombok.Data;
...
//
//
//    private static IFunctionInvoke functionInvoke = com.youlai.boot.common.util.SpringUtils.getBean(IFunctionInvoke.class);
//
//    private static DeviceService deviceService = SpringUtils.getBean(DeviceService.class);
//
...
//        // 判断定制触发（执行一次）或设备上报
//        boolean isDeviceReport = !StringUtils.isEmpty(deviceNum);
//        if (isDeviceReport) {
//            // 1. 匹配设备编号
